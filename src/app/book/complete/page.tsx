...
/** Booking acknowledgment and signing flow. Payment truth is loaded by CompleteContent. */
    ...
    <main className='relative min-h-screen overflow-x-hidden bg-zinc-950 text-foreground'>
      ...
      <div className='relative mx-auto max-w-lg px-4 pb-16 pt-10 sm:px-6 sm:pt-14'>
        <div className='mb-8 flex flex-col items-center text-center'>
          ...
          <p className='mt-1 text-xs text-zinc-500'>Review and complete your service acknowledgment</p>
        </div>
