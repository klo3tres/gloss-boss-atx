...
export function WorkOrderLedgerPanel({
  ...
  return (
    <div className='space-y-4'>
      {isTest && !showOnlyReceipt && !showOnlyPayments && !showOnlyAdvanced ? (
        <div className='flex flex-wrap gap-2'>
          <PremiumBadge tone='amber'>Test / sandbox</PremiumBadge>
        </div>
      ) : null}

      {ledgerWarnings && ledgerWarnings.length > 0 && !showOnlyReceipt && !showOnlyPayments && !showOnlyAdvanced ? (
      ...
      {(!showOnlyPayments && !showOnlyAdvanced) && (
      ...
      {(!showOnlyReceipt && !showOnlyAdvanced) && (
      ...
      {(!showOnlyPayments && !showOnlyAdvanced) && canManagePayments ? (
      ...
      {(!showOnlyPayments && !showOnlyReceipt) && canAdvancedRepair ? (
