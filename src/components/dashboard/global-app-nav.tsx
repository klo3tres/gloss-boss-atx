...
export function GlobalAppNav({ role }: { role: DashboardShellRole }) {
  ...
  return (
    <nav
      className="gb-no-print sticky top-0 z-[60] -mx-4 mb-4 border-b border-white/10 bg-black/90 px-4 py-2 backdrop-blur-md sm:-mx-6 sm:px-6 lg:static lg:mx-0 lg:mb-0 lg:border-0 lg:bg-transparent lg:px-0 lg:py-0"
