...
export function StickyBookCta({
  ...
  return (
    <div
      className="gb-sticky-book-cta fixed inset-x-0 bottom-0 z-[55] border-t border-gold/25 bg-black/90 px-4 py-3 backdrop-blur-xl sm:hidden"
      style={{ paddingBottom: 'max(0.75rem, env(safe-area-inset-bottom))' }}
    >
      <div className="mx-auto flex max-w-lg items-center gap-2">
        <a
          href={phoneHref}
          className="inline-flex h-12 w-12 shrink-0 items-center justify-center rounded-xl border border-white/15 text-gold-soft"
