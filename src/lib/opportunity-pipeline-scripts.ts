...
export function buildOpportunityScripts(opp: RevenueOpportunity, ctx: OpportunityScriptContext = {}): OpportunityScriptSet {
  ...
  return {
    call_script: `OPENING\nHey ${contact}, this is ${repName} with ${brandName} — premium mobile detailing in ${serviceArea}. You recently showed interest in ${opp.title.toLowerCase()}. Is now a bad time for a quick question?\n\nQUALIFYING QUESTIONS\n• What vehicle and service are you considering?\n• What matters most: interior reset, exterior protection, or both?\n• Do you have a preferred day and service address?\n• Is there a stain, pet hair, odor, coating, or deadline we should plan for?\n\nVALUE STATEMENT\nWe come to your location, confirm pricing before work begins, and keep your appointment, photos, receipts, loyalty, and future booking in one customer portal.\n\nCOMMON OBJECTIONS\n• "I need to think" — I can text exact options so there is no pressure.\n• "What's the price?" — I can quote accurately once I confirm vehicle size and condition.\n• "I'm busy" — That's exactly why we're mobile; I can text a booking link and available windows.\n\nASK\nWould you prefer exact pricing by text, or should I hold a time while we finish the details?\n\nVOICEMAIL\nHey ${contact}, this is ${repName} with ${brandName}. I'm following up on your detailing inquiry. We come to you in ${serviceArea}. I'll send a short message so you can reply whenever convenient.\n\nFOLLOW-UP\nHey ${contact}, just circling back from ${brandName}. If you still need the detail, I can send exact pricing or available times without any pressure.`,
